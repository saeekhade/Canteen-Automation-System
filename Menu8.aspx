<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu8.aspx.cs" Inherits="PROJECT.Menu8" %>
<!DOCTYPE html>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <div class="food-item">
                <img src="https://m.media-amazon.com/images/I/61+jGc7vLIL.jpg" class="centered-image"alt="centered-image" style="width: 100px; height: 100px" />
                <h3> Soft Drinks</h3>
                <p >₹15</p>
                <input type="number" min="0" value="1" />
                <button type="button" onclick="addToCart('Soft Drink 200ml', 15)">Add to Cart</button>
            </div>
             
                  <div class="food-item">
                     <img src="https://5.imimg.com/data5/SELLER/Default/2023/2/FQ/OJ/DA/21304714/100ml-bisleri-mineral-water-bottle.png" class="centered-image"alt="centered-image" style="width: 100px; height: 100px" />
                     <h3>Mineral Water</h3>
                     <p >₹20</p>
                     <input type="number" min="0" value="1" />
                     <button type="button" onclick="addToCart('Mineral Water [1L]', 20)">Add to Cart</button>
                </div>
           

              <div class="food-item">
               <img src="https://www.cookwithmanali.com/wp-content/uploads/2022/06/Nimbu-Paani.jpg" class="centered-image"alt="centered-image" style="width: 100px; height: 100px" />
              <h3>Nimbu Pani</h3>
              <p >₹15</p>
              <input type="number" min="0" value="1" />
              <button type="button" onclick="addToCart('Nimbu Pani', 15)">Add to Cart</button>
        </div>

            <div class="food-item">
               <img src="https://www.vegrecipesofindia.com/wp-content/uploads/2021/05/masala-chaas-2.jpg" class="centered-image"alt="centered-image" style="width: 100px; height: 100px" />
              <h3>Butter Milk</h3>
              <p >₹15</p>
              <input type="number" min="0" value="1" />
              <button type="button" onclick="addToCart('Butter Milk', 15)">Add to Cart</button>
        </div>
