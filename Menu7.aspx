<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu7.aspx.cs" Inherits="PROJECT.Menu7" %>
<!DOCTYPE html>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <div class="food-item">
                <img src="https://www.teacupsfull.com/cdn/shop/articles/Screenshot_2023-10-20_at_11.07.13_AM.png?v=1697780292" class="centered-image"alt="centered-image" style="width: 100px; height: 100px" />
                <h3> Tea cutting </h3>
                <p >₹7</p>
                <input type="number" min="0" value="1" />
                <button type="button" onclick="addToCart('Tea Cutting', 7)">Add to Cart</button>
            </div>

             <div class="food-item">
                 <img src="https://i0.wp.com/cookingfromheart.com/wp-content/uploads/2018/07/Masala-Chai-5.jpg?resize=683%2C1024&ssl=1" class="centered-image"alt="centered-image" style="width: 100px; height: 100px" />
                 <h3>Tea full </h3>
                 <p >₹12</p>
                 <input type="number" min="0" value="1" />
                 <button type="button" onclick="addToCart('Tea Full', 12)">Add to Cart</button>
             </div>
             
           
             <div class="food-item">
               <img src="https://img.freepik.com/free-photo/delicious-coffee-beans-cup_23-2150691429.jpg?size=626&ext=jpg&ga=GA1.1.967060102.1708992000&semt=sph" class="centered-image"alt="centered-image" style="width: 100px; height: 100px" />
               <h3>Coffee</h3>
                <p >₹18</p>
              <input type="number" min="0" value="1" />
             <button type="button" onclick="addToCart('Coffee', 18)">Add to Cart</button>
            </div>
