<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu5.aspx.cs" Inherits="PROJECT.Menu51" %>
<!DOCTYPE html>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <div class="food-item">
                <img src="https://1.bp.blogspot.com/-5rrpZp-6Q8Y/Xs7VtkpuVOI/AAAAAAAAKEo/q-_IRK84kRwdAPkLmdWs0E8VhhRsQqAbQCLcBGAsYHQ/s1600/Bhel%2BPuri%2BRecipe.JPG" class="centered-image"alt="centered-image" style="width: 100px; height: 100px" />
                <h3> Bhelpuri </h3>
                <p >₹30</p>
                <input type="number" min="0" value="1" />
                <button type="button" onclick="addToCart('Bhelpuri', 30)">Add to Cart</button>
            </div>

             <div class="food-item">
                 <img src="https://c.ndtvimg.com/2023-10/vrhihepg_sev-puri_625x300_23_October_23.jpg?im=FaceCrop,algorithm=dnn,width=1200,height=738" class="centered-image"alt="centered-image" style="width: 100px; height: 100px" />
                 <h3>Sevpuri</h3>
                 <p >₹25</p>
                 <input type="number" min="0" value="1" />
                 <button type="button" onclick="addToCart('Sevpuri', 25)">Add to Cart</button>
             </div>
             
           
             <div class="food-item">
               <img src="https://media.istockphoto.com/id/1314802039/photo/forehead-castle-chat.jpg?s=612x612&w=0&k=20&c=_FdVXvODCNpdJ9QujyAD6eaL9waZ6Yp01kfVIMxyjW4=" class="centered-image"alt="centered-image" style="width: 100px; height: 100px" />
               <h3>Dahipuri</h3>
                <p >₹25</p>
              <input type="number" min="0" value="1" />
             <button type="button" onclick="addToCart('Dahipuri', 25)">Add to Cart</button>
            </div>

                    <div class="food-item">
                      <img src="https://i.pinimg.com/originals/57/5f/79/575f79dba287ff267c96eb8839bc83e0.jpg" class="centered-image"alt="centered-image" style="width: 100px; height: 100px" />
                      <h3>Chinese Bhel</h3>
                      <p >₹20</p>
                     <input type="number" min="0" value="1" />
                    <button type="button" onclick="addToCart('Chinese Bhel', 20)">Add to Cart</button>
                  </div>
