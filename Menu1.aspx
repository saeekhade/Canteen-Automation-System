<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Menu1.aspx.cs" Inherits="PROJECT.Menu" %>
<!DOCTYPE html>
...
<body>
    <form id="form1" runat="server">
        <div> 
            ...
            <div class="food-item">
                <img src="https://www.cookwithmanali.com/wp-content/uploads/2018/04/Vada-Pav-500x375.jpg" class="centered-image"alt="centered-image" style="width: 100px; height: 100px" />
                <h3> Vadapav </h3>
                <p >₹20</p>
                <p>Batata Vada which is sandwiched between two slices of a pav topped with sweet chutney, green chutney, and dry garlic chutney.</p>
                <input type="number" min="0" value="1" />
                <button type="button" onclick="addToCart('Vadapav', 20)">Add to Cart</button>
            </div>

             <div class="food-item">
                 <img src="https://cdn.tarladalal.com/members/9306/big/big_samosa-pav-(-mumbai-roadside-recipes-)-2125.jpg" class="centered-image"alt="centered-image" style="width: 100px; height: 100px" />
                 <h3>Samosa </h3>
                 <p >₹20</p>
                 <p> Samosas are stuffed in pav along with green chutney, sweet tamarind chutney and a dry garlic red chili chutney.</p>
                 <input type="number" min="0" value="1" />
                 <button type="button" onclick="addToCart('Samosa', 20)">Add to Cart</button>
             </div>
             
                  <div class="food-item">
                     <img src="https://t4.ftcdn.net/jpg/04/65/28/87/240_F_465288715_F3uc0aZMhzSbNbftEzHSb6RfUVQfCHeU.jpg" class="centered-image"alt="centered-image" style="width: 100px; height: 100px" />
                     <h3>Idli Vada</h3>
                     <p >₹40</p>
                     <p> These items are often served together along with coconut chutney and sambar, creating a wholesome and satisfying meal.</p>
                     <input type="number" min="0" value="1" />
                     <button type="button" onclick="addToCart('Idli Vada', 40)">Add to Cart</button>
                </div>
           
             <div class="food-item">
               <img src="https://www.indianveggiedelight.com/wp-content/uploads/2022/07/poha-recipe-featured.jpg" class="centered-image"alt="centered-image" style="width: 100px; height: 100px" />
               <h3>Kanda Poha</h3>
                <p >₹25</p>
                <p>Breakfast dish made from poha, onions, mustard seeds, curry leaves,turmeric, and various spices.</p>
              <input type="number" min="0" value="1" />
             <button type="button" onclick="addToCart('Kanda Poha', 25)">Add to Cart</button>
            </div>

                           <div class="food-item">
               <img src="https://www.lekhafoods.com/media/1051242/rava-sheera.jpg" class="centered-image"alt="centered-image" style="width: 100px; height: 100px" />
              <h3>Sheera</h3>
              <p >₹25</p>
              <p>  Sheera is delightful Indian sweet dish. It is made from semolina (sooji/rawa), ghee (clarified butter), sugar, and water or milk. </p>
             <input type="number" min="0" value="1" />
              <button type="button" onclick="addToCart('Sheera', 25)">Add to Cart</button>
        </div>
